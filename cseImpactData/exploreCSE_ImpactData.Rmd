...
```{r terrEmAbs, fig.caption = "Wider Hampshire area total territorial emissions (T CO2e 2019-20)"}
...
```{r consEmAbs, fig.caption = "Wider Hampshire area total consumption emissions (T CO2e 2019-20)"}
...
```{r consEmPerHH, fig.caption = "Wider Hampshire area per household consumption emissions (T CO2e 2019-20)"}
